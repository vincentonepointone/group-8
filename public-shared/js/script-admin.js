  ...
  for(let i = 1; i <= paddingDays + daysInMonth; i++) { 
    ...
    if (i > paddingDays) {
      ...
      if (eventForDay) {
        ...
        const dayShiftPtag = document.createElement('div');
        const dayShiftPtagDiv = document.createElement('div');
        dayShiftPtagDiv.classList.add('dayShiftPtagDiv')
        dayShiftPtag.classList.add('dayShiftPtag');
        // dayShiftPtag.innerText = 'Dag';
          dayShiftPtag.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun" viewBox="0 0 16 16">
        ...
        dayShiftPtagDiv.append(dayShiftPtag);
        dayShiftDiv.append(dayShiftPtagDiv);
        ...
        const nightShiftPtag = document.createElement('div');
        const nightShiftPtagDiv = document.createElement('div');
        nightShiftPtagDiv.classList.add('nightShiftPtagDiv')
        nightShiftPtag.classList.add('nightShiftPtag');
        nightShiftPtag.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
                                      <path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z"/>
                                    </svg>`
        nightShiftPtagDiv.append(nightShiftPtag);
        nightShiftDiv.append(nightShiftPtagDiv);
        ...
        const offShiftPtag = document.createElement('div');
        const offShiftPtagDiv = document.createElement('div');
        offShiftPtag.classList.add('offShiftPtag');
        offShiftPtagDiv.classList.add('offShiftPtagDiv')
        // offShiftPtag.innerText = 'OFF.'
        offShiftPtag.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-heart" viewBox="0 0 16 16">
                                    <path d="M8 6.982C9.664 5.309 13.825 8.236 8 12 2.175 8.236 6.336 5.309 8 6.982Z"/>
                                    <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.707L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.646a.5.5 0 0 0 .708-.707L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
                                  </svg>`
        offShiftPtagDiv.append(offShiftPtag);
        offShiftDiv.append(offShiftPtagDiv);
        ...
        const errShiftPtag = document.createElement('div');
        errShiftPtag.classList.add('errShiftPtag');
        errShiftPtag.innerText = 'Err'
        errShiftDiv.append(errShiftPtag);
        ...
        // namesDiv.classList.add('col')
 
        daySquare.appendChild(dayShiftDiv);
        daySquare.appendChild(nightShiftDiv);
        daySquare.appendChild(offShiftDiv);
